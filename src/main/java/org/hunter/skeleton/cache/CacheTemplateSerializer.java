...
public class CacheTemplateSerializer {
    ...
    public static StringRedisTemplate createStringTemplate(LettuceConnectionFactory factory) {
    ...
    public static RedisTemplate<String, Object> createObjectTemplate(LettuceConnectionFactory factory) {
