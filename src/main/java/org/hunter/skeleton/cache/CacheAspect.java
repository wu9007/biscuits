...
import org.hunter.skeleton.annotation.Cache;
...
public class CacheAspect {
    private ResponseCache cacheUtils;

    @Autowired
    public CacheAspect(ResponseCache cacheUtils) {
        this.cacheUtils = cacheUtils;
    }

    @Around("@annotation(org.hunter.skeleton.annotation.Cache)")
