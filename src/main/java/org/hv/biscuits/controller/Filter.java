...
public class Filter implements Serializable {
    ...
    public static Filter newEquInstance(String key, Object value) {
        return Filter.newInstance(key, value, FilterView.Operate.EQU, null);
    }

    public static Filter newInstance(String key, Object value, String operate, String valueType) {
        return new Filter(key, value, operate, valueType);
    }
