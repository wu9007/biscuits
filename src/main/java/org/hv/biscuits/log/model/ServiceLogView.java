...
public class ServiceLogView implements Serializable {
    ...
    public ServiceLogView(String traceId, String requestId, String userName) {
        this.startDateTime = LocalDateTime.now();
    ...
    public ServiceLogView(String traceId, String requestId, String userName, String businessDeptName) {
        this.startDateTime = LocalDateTime.now();
        this.traceId = traceId;
        this.requestId = requestId;
        this.userName = userName;
    ...
    public ServiceLogView setTraceId(String traceId) {
        this.traceId = traceId;
        return this;
    }
    ...
    public ServiceLogView setUserName(String userName) {
        this.userName = userName;
        return this;
    }
    ...
    public ServiceLogView setBusinessDeptName(String businessDeptName) {
        this.businessDeptName = businessDeptName;
        return this;
    }
}
